...
})({"a24Xg":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "ed116a0cd347d37f";
...
},{}],"cxZJI":[function(require,module,exports) {
...
(function() {
    if (localStorage.getItem("saved-state")) (0, _state.state).init();
    else (0, _state.state).setState({
        userId: "",
        roomId: "",
        rtdbRoomId: "",
        roomCreator: "",
...
},{"./router.ts":"asTyk","./pagesInit":"2H8bQ","./componentsInit":"a9HNs","./state":"gYADE"}],"asTyk":[function(require,module,exports) {
...
},{}],"2H8bQ":[function(require,module,exports) {
//Pages
...
var _index = require("./pages/path-page/index");

},{"./pages/home-page/homePage":"bbqUZ","./pages/access-page/accessPage":"h2qsv","./pages/game-room/gameRoomPage":"hSAL1","./pages/choose-room/chooseRoomPage":"74l5D","./pages/instructions-page/instructionsPage":"cPCp3","./pages/comparition-page/comparitionPage":"k4TCv","./pages/waitingPage/waitingPage":"bPPbt","./pages/result-page/resultPage":"43v6H","./pages/path-page/index":"kc2u3"}],"bbqUZ":[function(require,module,exports) {
...
},{}],"h2qsv":[function(require,module,exports) {
var _router = require("@vaadin/router");
var _state = require("../../state");
    ...
    addListeners() {
        ...
        form.addEventListener("submit", async (e)=>{
            ...
            (0, _state.state).signIn(()=>{
                (0, _state.state).accesToGameRoom(()=>{
                    (0, _router.Router).go("/game-room");
                    (0, _state.state).guestPlayer();
                });
            });
        });
    }
...
},{"@vaadin/router":"kVZrF","../../state":"gYADE"}],"gYADE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const state = {
    ...
    listenRTDBData () {
        ...
        const gameRoomRef = (0, _rtdb.ref)((0, _rtdb.rtdb), `/gamerooms/${cs.rtdbRoomId}/currentGame`);
        (0, _rtdb.onValue)(gameRoomRef, (snapshot)=>{
    ...
    async signIn (cb) {
        ...
        if (cs.email) {
            ...
            this.setState(cs);
            if (cb) cb();
        } else console.error("no hay un mail en el state");
    },
    ...
    async playersChoice (localOrGuest, choice, callback) {
        //recibe "playerOne" o "playerTwo"
    ...
    async growScore (player, callback) {
        const cs = this.getState();
        const rtdbRoomId = cs.rtdbRoomId;
        const score = cs.roomCreator ? cs.rtdbData.playerOne.score : cs.rtdbData.playerTwo.score;
    ...
    whoWins (localMove, guestMove, callback) {
        const cs = this.getState();
        ...
        if (ganaPlayerOne) {
            if (iAmLocal) state.growScore("playerOne", ()=>{
                state.setState({
                    ...cs,
                    result: "ganaste"
                });
        ...
        if (ganaPlayerTwo) {
            if (!iAmLocal) state.growScore("playerTwo", ()=>{
                state.setState({
                    ...cs,
                    result: "ganaste"
                });
...
},{"./rtdb":"lAIXy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lAIXy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "rtdb", ()=>rtdb);
parcelHelpers.export(exports, "ref", ()=>(0, _database.ref));
parcelHelpers.export(exports, "onValue", ()=>(0, _database.onValue));
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bpqHw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _database = require("@firebase/database");
 ...
 */ class StatsCollection {
    ...
    incrementCounter(name2, amount = 1) {
        if (!(0, _util.contains)(this.counters_, name2)) this.counters_[name2] = 0;
...
function validationPathPush(validationPath, child1) {
    ...
    validationPath.byteLength_ += (0, _util.stringLength)(child1);
 ...
 */ class PersistentConnection extends ServerActions {
    ...
    listen(query4, currentHashFn, tag, onComplete) {
        ...
        (0, _util.assert)(query4._queryParams.isDefault() || !query4._queryParams.loadsAllData(), "listen() called for non-default but complete query");
     ...
     */ unlisten(query7, tag) {
        ...
        (0, _util.assert)(query7._queryParams.isDefault() || !query7._queryParams.loadsAllData(), "unlisten() called for non-default but complete query");
    ...
    onListenRevoked_(pathString, query8) {
        ...
        else queryId = query8.map((q)=>ObjectToUniqueKey(q)).join("$");
        const listen = this.removeListen_(pathString, queryId);
 ...
 */ class ReadonlyRestClient extends ServerActions {
    ...
    static getListenId_(query9, tag) {
        if (tag !== undefined) return "tag$" + tag;
            ...
            (0, _util.assert)(query9._queryParams.isDefault(), "should have a tag if it's not a default query.");
            ...
            if (write.snap) {
                ...
                if (pathContains(treeRoot, writePath)) {
                    ...
                    if (pathIsEmpty(relativePath)) compoundWrite = compoundWriteAddWrites(compoundWrite, newEmptyPath(), write.children);
                        ...
                        const child10 = (0, _util.safeGet)(write.children, pathGetFront(relativePath));
                        if (child10) {
 ...
 */ function treeSubTree(tree, pathObj) {
    ...
    while(next !== null){
        const childNode = (0, _util.safeGet)(child13.node.children, next) || {
            children: {},
            childCount: 0
        };
 ...
 */ function repoGetValue(repo, query30) {
    ...
    return repo.server_.get(query30).then((payload)=>{
        ...
        repoLog(repo, "get for query " + (0, _util.stringify)(query30) + " failed: " + err);
 ...
 */ function onDisconnect(ref4) {
    ref4 = (0, _util.getModularInstance)(ref4);
 ...
 */ function set(ref6, value) {
    ref6 = (0, _util.getModularInstance)(ref6);
 ...
 */ function setPriority(ref7, priority) {
    ref7 = (0, _util.getModularInstance)(ref7);
 ...
 */ function get(query34) {
    query34 = (0, _util.getModularInstance)(query34);
 ...
 */ function query(query55, ...queryConstraints) {
    let queryImpl = (0, _util.getModularInstance)(query55);
...
transactionUpdate, options) {
    var _a;
    ref10 = (0, _util.getModularInstance)(ref10);
...
},{"@firebase/app":"3AcPV","@firebase/component":"bi1VB","@firebase/util":"ePiK6","@firebase/logger":"fZmft","process":"d5jf4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d5jf4":[function(require,module,exports) {
...
},{}],"hSAL1":[function(require,module,exports) {
var _router = require("@vaadin/router");
var _state = require("../../state");
class GameRoomPage extends HTMLElement {
    ...
    beforeClose() {
        ...
        const button = this.shadow.querySelector(".startGame");
        const shareMessage = this.shadow.querySelector(".share-message");
        const bothReady = this.shadow.querySelector(".cuandoEstesListo");
...
},{"@vaadin/router":"kVZrF","../../state":"gYADE"}],"74l5D":[function(require,module,exports) {
var _state = require("../../state");
var _router = require("@vaadin/router");
class ChoosePage extends HTMLElement {
    ...
    setingChoice() {
        ...
        tijera.addEventListener("click", ()=>{
            if (cs.roomCreator) (0, _state.state).playersChoice("playerOne", "tijera", ()=>{
                (0, _router.Router).go("/waiting");
            });
            else (0, _state.state).playersChoice("playerTwo", "tijera", ()=>{
                (0, _router.Router).go("/waiting");
            });
        });
        papel.addEventListener("click", ()=>{
            if (cs.roomCreator) (0, _state.state).playersChoice("playerOne", "papel", ()=>{
                (0, _router.Router).go("/waiting");
            });
            else (0, _state.state).playersChoice("playerTwo", "papel", ()=>{
                (0, _router.Router).go("/waiting");
            });
        });
        piedra.addEventListener("click", ()=>{
            if (cs.roomCreator) (0, _state.state).playersChoice("playerOne", "piedra", ()=>{
                (0, _router.Router).go("/waiting");
            });
            else (0, _state.state).playersChoice("playerTwo", "piedra", ()=>{
                (0, _router.Router).go("/waiting");
            });
        });
    }
...
},{"../../state":"gYADE","@vaadin/router":"kVZrF"}],"cPCp3":[function(require,module,exports) {
var _router = require("@vaadin/router");
var _state = require("../../state");
class instructions extends HTMLElement {
    ...
    userIsReady() {
        ...
        playButton.addEventListener("click", ()=>{
            if (cs.roomCreator) (0, _state.state).playerIsReady("playerOne", ()=>{
                (0, _router.Router).go("/choose-room");
            });
            else if (!cs.roomCreator) (0, _state.state).playerIsReady("playerTwo", ()=>{
                (0, _router.Router).go("/choose-room");
            });
        });
    }
...
},{"@vaadin/router":"kVZrF","../../state":"gYADE"}],"k4TCv":[function(require,module,exports) {
var _router = require("@vaadin/router");
var _state = require("../../state");
class ComparitionPage extends HTMLElement {
    ...
    connectedCallback() {
        ...
        const cs = (0, _state.state).getState();
        setTimeout(()=>{
            (0, _state.state).whoWins(cs.rtdbData.playerOne.choice, cs.rtdbData.playerTwo.choice, ()=>{
                (0, _router.Router).go("/result");
                (0, _state.state).listenRTDBData();
            });
        }, 2000);
    }
}
...
},{"@vaadin/router":"kVZrF","../../state":"gYADE"}],"bPPbt":[function(require,module,exports) {
var _state = require("../../state");
var _router = require("@vaadin/router");
class WaitingPage extends HTMLElement {
    ...
    asksIfTheOtherPlayerChoosed() {
        const setIN = setInterval(()=>{
            ...
            if (!cs.roomCreator && this.cuentaRegresiva == 0 && playerOneNoEligio && playerTwoEligio || cs.roomCreator && this.cuentaRegresiva == 0 && playerOneEligio && playerTwoNoEligio) {
                clearInterval(setIN);
                (0, _router.Router).go("/result");
            } else if (playerOneEligio && playerTwoEligio) {
                clearInterval(setIN);
                (0, _router.Router).go("/comparition");
            }
...
},{"../../state":"gYADE","@vaadin/router":"kVZrF"}],"43v6H":[function(require,module,exports) {
var _state = require("../../state");
var _router = require("@vaadin/router");
class ResultPage extends HTMLElement {
    ...
    sync() {
        this.render();
        (0, _state.state).listenRTDBData();
        const playAgainButton = this.shadow.querySelector(".playAgainButton");
        playAgainButton.addEventListener("click", ()=>{
            (0, _state.state).replay(()=>{
                (0, _router.Router).go("/instructions");
            });
        });
    }
...
},{"../../state":"gYADE","@vaadin/router":"kVZrF"}],"kc2u3":[function(require,module,exports) {
...
},{}],"a9HNs":[function(require,module,exports) {
//Components
...
var _index = require("./components/welcome-form/index");
var _index1 = require("./components/questionary/index");
var _index2 = require("./components/replay/index");

},{"./components/customText":"iwbYA","./components/button":"4ypX6","./components/showName":"i9qZO","./components/roomCode":"ezucF","./components/marcador":"3jPaU","./components/shareCodeMessage":"1CruZ","./components/game-option":"5W5jd","./components/contador":"6hbD4","./components/muestraJugada":"6zqoF","./components/scoreComp":"bm7i6","./components/starComp":"csnI8","./components/welcome-form/index":"2rX7g","./components/questionary/index":"9imKJ","./components/replay/index":"cNXai"}],"iwbYA":[function(require,module,exports) {
...
},{}],"4ypX6":[function(require,module,exports) {
class Button extends HTMLElement {
    ...
    `;
        const button = this.shadow.querySelector(".root");
...
},{}],"i9qZO":[function(require,module,exports) {
var _state = require("../state");
...
},{"../state":"gYADE"}],"ezucF":[function(require,module,exports) {
var _state = require("../state");
...
},{"../state":"gYADE"}],"3jPaU":[function(require,module,exports) {
var _state = require("../state");
...
},{"../state":"gYADE"}],"1CruZ":[function(require,module,exports) {
var _state = require("../state");
...
},{"../state":"gYADE"}],"5W5jd":[function(require,module,exports) {
...
},{"../img/tijera.svg":"f00IZ","../img/papel.svg":"kk3f9","../img/piedra.svg":"atWff"}],"f00IZ":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("klUgy") + "tijera.9af5d5f2.svg" + "?" + Date.now();
...
},{}],"kk3f9":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("klUgy") + "papel.e3ba99fe.svg" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"atWff":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("klUgy") + "piedra.d52cead2.svg" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"6hbD4":[function(require,module,exports) {
var _router = require("@vaadin/router");
var _state = require("../state");
class Contador extends HTMLElement {
    ...
    async cuentaAtras() {
        const setIN = setInterval(()=>{
            ...
            if (terminoTiempo) {
                clearInterval(setIN);
                if (playerOneNoEligio && playerTwoNoEligio) (0, _router.Router).go("/instructions");
                if (cs.roomCreator && playerOneNoEligio) (0, _state.state).growScore("playerTwo", ()=>{
                    cs.result = "perdiste";
                    (0, _state.state).setState(cs);
                    (0, _router.Router).go("/result");
                });
                if (!cs.roomCreator && playerTwoNoEligio) (0, _state.state).growScore("playerOne", ()=>{
                    cs.result = "perdiste";
                    (0, _state.state).setState(cs);
                    (0, _router.Router).go("/result");
                });
            } else if (!playerOneNoEligio && !playerTwoNoEligio) clearInterval(setIN);
...
},{"@vaadin/router":"kVZrF","../state":"gYADE"}],"6zqoF":[function(require,module,exports) {
var _state = require("../state");
...
},{"../state":"gYADE"}],"bm7i6":[function(require,module,exports) {
var _state = require("../state");
...
},{"../state":"gYADE"}],"csnI8":[function(require,module,exports) {
var _state = require("../state");
...
},{"../state":"gYADE","../img/ganaste.svg":"goGzL","../img/perdiste.svg":"kCYJY","../img/empataste.svg":"ctrjC"}],"goGzL":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("klUgy") + "ganaste.17f6641d.svg" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"kCYJY":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("klUgy") + "perdiste.f89c2ccd.svg" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"ctrjC":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("klUgy") + "empataste.4faaa920.svg" + "?" + Date.now();

},{"./helpers/bundle-url":"lgJ39"}],"2rX7g":[function(require,module,exports) {
var _state = require("../../state");
var _router = require("@vaadin/router");
class WelcomeForm extends HTMLElement {
    ...
    addListeners() {
        ...
        form.addEventListener("submit", async (e)=>{
            ...
            (0, _router.Router).go("/path");
            (0, _state.state).setNombreAndEmail(nombre, email);
            (0, _state.state).createPlayer();
        });
    }
    connectedCallback() {
        this.addListeners();
...
},{"../../state":"gYADE","@vaadin/router":"kVZrF"}],"9imKJ":[function(require,module,exports) {
var _state = require("../../state");
var _router = require("@vaadin/router");
class Questinary extends HTMLElement {
    ...
    addListeners() {
        ...
        probar.addEventListener("click", function() {
            (0, _router.Router).go("/access-room");
        });
        crear.addEventListener("click", ()=>{
            (0, _state.state).signIn(()=>{
                (0, _state.state).askNewGameRoom(()=>{
                    (0, _router.Router).go("/game-room");
                    (0, _state.state).accesToGameRoom();
                });
            });
...
},{"../../state":"gYADE","@vaadin/router":"kVZrF"}],"cNXai":[function(require,module,exports) {
var _state = require("../../state");
var _router = require("@vaadin/router");
class WantReplay extends HTMLElement {
    ...
    listeners() {
        const cs = (0, _state.state).getState();
        if (cs.rtdbData.replay == true) this.clasStyle = "mostrado";
        else this.clasStyle = "escondido";
        this.render();
        const button = this.shadow.querySelector(".aceptar");
        button.addEventListener("click", async ()=>{
            await (0, _state.state).cleaningReplay(()=>{
                (0, _router.Router).go("/instructions");
            });
        });
    }
...
},{"../../state":"gYADE","@vaadin/router":"kVZrF"}]},["a24Xg","cxZJI"], "cxZJI", "parcelRequireca0a")

//# sourceMappingURL=index.d347d37f.js.map
